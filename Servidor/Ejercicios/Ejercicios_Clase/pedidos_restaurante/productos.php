...
<html>
	...
	<body>
		...
		foreach($productos as $producto){
			...
			<input type = 'submit' value='Añadir'><input name = 'cod' type='hidden' value = '$cod'>


            <input type = 'submit' value='Eliminar'><input name = 'cod' type='hidden' value = '$cod'>
			</form></td></tr>";
		}
        //encontrar algo en el carrito y eliminar las que quieres, elimina el numero que indica
		echo "</table>"			
		?>				
	</body>
</html>